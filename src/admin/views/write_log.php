<?phpnif(!defined('EMLOG_ROOT')) {exit('error!');}?>
<script charset="utf-8" src="./editor/kindeditor.js?v=<?php echo Option::EMLOG_VERSION; ?>"></script>
<script charset="utf-8" src="./editor/lang/zh_CN.js?v=<?php echo Option::EMLOG_VERSION; ?>"></script>
<div class=containertitle><b><?php echo $containertitle;?></b><span id="msg_2"></span></div>
<div id="msg"></div>
<form action="save_log.php?action=save" method="post" enctype="multipart/form-data" id="addlog" name="addlog">
<div id="post">
<div>
...
<div style="margin:10px 0px 5px 0px;">
    ...
    <input name="date" id="date" type="hidden"  value="<?php echo $postDate; ?>">
</div>
<div id="tagbox">
<?php
    if ($tags) {
...
<div id="advset">
<div>文章摘要：</div>
<div><textarea id="excerpt" name="excerpt" style="width:845px; height:260px;"><?php echo $excerpt; ?></textarea></div>
